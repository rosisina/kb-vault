...
**Source:** raw/01. book-beyond-cybersecurity/Korean/13-3-7-37-제7층위-진정서.md (book §3.7.2.1)
...
- `Korean/13-3-7-37-제7층위-진정서.md` — §3.7.2.1 (lines 40–46): detailed description of the 국가권익위원회 section; the transfer attempt is explicitly described and the 2022-10-04 recording is offered as the primary evidence. Section header: `3.7.2.1. 국가권익위원위에 진정서 제출과 그 과정 및 결과`.
