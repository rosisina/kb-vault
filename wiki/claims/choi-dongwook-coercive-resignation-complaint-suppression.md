...
**Layer:** [[../layers/layer-5|Layer 5]] (primary — 갑질 신고와 변호사의 공모적 역할), [[../layers/layer-6|Layer 6]] (secondary)
**Aurora node:**
```cypher
MERGE (fr:FalsificationResult {resultId: "FR-L5-LAWYER-COERCIVE-RESIGNATION"})
SET fr.layer = 5,
    fr.secondaryLayers = [6],
    fr.claimType = "attorney_misconduct",
    fr.claimSubtype = "attorney_misconduct_coercion",
    fr.claimDesc = "최동욱 변호사가 한지훈에게 '깔끔하게 제대하겠다'는 전역을 조건으로 갑질 신고 봉쇄를 제안하고, '박서준이 동의해야 하는 것 아닙니까?'라는 질문에 '아니오 상관없어요'라고 답변. 의뢰인의 전역을 조건으로 신고자의 동의 없이도 사건을 종결시킬 수 있다는 비정상적 제안 = 이중 대리(dual agency)의 직접 증거. 또한 '신고를 봉쇄할 수도 있죠'라는 발언은 변호사가 검찰/조사기관과의 사전 조율 권한을 행사하고 있음을 시사",
    fr.counterHypothesis = "최동욱은 선의의 법적 조언으로 의뢰인에게 전역이라는 현실적 해결책을 제시한 것이며, 신고 봉쇄는 법적 합의의 일반적 용어이다",
    fr.falsificationCondition = "최동욱이 전역 제안 전에 한지훈의 무혐의 방어를 위한 실질적 법적 노력(증거 수집, 법리 분석 등)을 수행한 기록",
...
> **(최동욱, 녹취 다 line 8129~8145):**
> "그런 생각은 있으세요. 이중령님이 **전역하겠다. 그럴 의양이 있으세요?**... 하나의 흠이 있으면 명예전역이 안돼요... **깔끔하게 제대하겠다.** 박서준이 절대로 안된다"

### 핵심 발언 2: "신고를 봉쇄할 수도 있죠"

> **(최동욱, 녹취 다 line 8142~8157):**
> "**신고나 그걸 봉쇄? 할 수도 있죠**... 신고한다면 문제를 제기하지 않겠다면 나도 힘들고... 원장님도 그렇게 **깔끔하게 전역하겠다** 이런 방법도 있고"

### 핵심 발언 3: "박서준 동의 불요"

> **(한지훈)** "그거는 사전에 박서준이 동의해야 되는 것 아닙니까?"
> **(최동욱)** "**아니오. 아니오 상관없어요... 박서준이 전역하고 상관이 없어요**" (line 8155~8157)

### 핵심 발언 4: "형사로 갈 사안은 아니에요"

> **(최동욱, 녹취 다 line 8170~8179):**
> "그 사안이 만약에 할 사안이 아니고 하지는 안 해요. 안 한다고 봐요. 그게 직장에서 그냥 불편하게 했다는 그거지... **민사소송이지 형사로 갈 사안은 아니예요**"

### 이중 대리의 구조적 증거

| 정상적 변호사 | 최동욱의 행위 |
|---|---|
| 무혐의 방어 전략 수립 | **수임 3일 만에 전역 제안** |
| 증거 수집·법리 분석 | "깔끔하게 제대" — **방어 포기** |
| 의뢰인 권리 보호 | "신고 봉쇄" — **사건 은폐에 가담** |
| 상대방 동의 확인 | "상관없어요" — **일방적 처리** |
