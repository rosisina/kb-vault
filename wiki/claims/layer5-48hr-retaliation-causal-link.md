...
- `vault-converted-korean/11-3-5-35-제-5층위.md` — §3.5.1.1 ("조직적 증인 제거 작전"), §3.5.2.3.2 (7단계 프로세스 Phase 1), §3.5.1.7 (D2 정의 + P1/P2 명제): 모두 일치. 책은 48시간 인과 관계를 정의로 명시하고 명제로 증명한다.
- `vault-converted-korean/07-3-1-31-제1층위-ActiveX.md` — §3.1 (舊KIATIS 인터넷 노출 = DIDC 해킹 근원 서버): P6 상위 의도 구조 교차 확인.
