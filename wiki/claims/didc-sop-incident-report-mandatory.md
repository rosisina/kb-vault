...
- `vault-converted-korean/07-3-1-31-제1층위-ActiveX.md` — Layer 1 chapter (primary; references DIDC 예규)
- `vault-converted-korean/12-3-6-36-제6층위-군.md` — Layer 6 chapter (prosecution context for incident-report absence)
