...
- `Korean/03-executive-summary--핵심-요약.md` — Executive summary (CONFIRMED 행정정보화과장 mention)
- `Korean/07-3-1-31-제1층위-ActiveX.md` — Layer 1 chapter (CONFIRMED)
- `Korean/09-3-3-33-제3-층위.md` — Layer 3 chapter (CONFIRMED)
- `Korean/10-3-4-34-제4-층위.md` — Layer 4 chapter (CONFIRMED)
- `Korean/11-3-5-35-제-5층위.md` — Layer 5 chapter (CONFIRMED)
- `Korean/12-3-6-36-제6층위-군.md` — Layer 6 chapter (CONFIRMED)
