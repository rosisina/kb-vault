...
**Source:** raw/01. book-beyond-cybersecurity/Korean/10-3-4-34-제4-층위.md (§3.4.3.4 KIDA 인용 추적), wiki/claims/kida-otne-citation-misrepresents-us-standard.md (Track D D1 closure 참조)
...
- `Korean/10-3-4-34-제4-층위.md` §3.4.3.4 — KIDA 인용 추적 서사 재확인 필요.
- `Korean/12-3-6-36-제6층위-군.md` — Layer 6 검찰단 신문에서 제2275호가 등장하는 구체 문단 확인 필요.
- `Korean/07-3-1-31-제1층위-ActiveX.md` — Layer 1 훈령 조작 타임라인의 상위 mechanism.
