...
- `Korean/08-3-2-32-제2-층위.md` — Layer 2 chapter (CONFIRMED 제58조 mention)
- `Korean/09-3-3-33-제3-층위.md` — Layer 3 chapter (CONFIRMED 제58조 mention)
- `Korean/10-3-4-34-제4-층위.md` — Layer 4 chapter (CONFIRMED 제58조 framework analysis)
- `Korean/12-3-6-36-제6층위-군.md` — Layer 6 chapter (CONFIRMED — primary source for the 불기소이유서 legal-error analysis)
