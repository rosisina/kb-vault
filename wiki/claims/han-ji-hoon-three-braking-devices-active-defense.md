...
**Source:** raw/01. book-beyond-cybersecurity/Korean/08-3-2-32-제2-층위.md (§3.2.2 footnote 113)
...
- `Korean/08-3-2-32-제2-층위.md` line 84, footnote 113 — primary source, 3가지 brake + 1가지 거절 + attestation records 모두 단일 footnote 안에 명시
- `Korean/12-3-6-36-제6층위-군.md` (Layer 6 chapter) — 검찰 prosecution의 사기 의도 주장과 비교
