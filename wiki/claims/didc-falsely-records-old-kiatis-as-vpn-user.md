...
SET fr.layer = 4,
    fr.claimType = "document_falsification",
...
- `vault-converted-korean/10-3-4-34-제4-층위.md` lines 118-139 — §3.4.2.2 verbatim

## Related

- [[old-kiatis-direct-db-access-without-vpn]] — L1 舊KIATIS DB 직접접속
- [[firewall-requests-confirm-no-vpn-db-direct-access]] — L4 방화벽 공문 추가 증거
