...
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.3.2 — 참고인 진술서 날짜·기록번호·문답 인용 — CONFIRMED
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.3.3 — 수사개시 통보 기록번호 — CONFIRMED
