...
**Source:** raw/01. book-beyond-cybersecurity/Korean/10-3-4-34-제4-층위.md (book §3.4.7.1)
...
## 원전 확인 (Spot-check)
- `Korean/10-3-4-34-제4-층위.md` — §3.4.7.1: 기록 제2,853~2,858쪽 인용 확인. 이지영(공문결재자-1)·김수진(행정담당자-1) 역할 앵커 확인. 시험평가 기간 2019-09-02~09-11 기술 확인. 09-03 시간 역전 기술 확인. 각주 310의 국전원장 08-29 승인 사실 확인.
