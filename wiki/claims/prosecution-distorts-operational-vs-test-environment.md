...
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.3.1 (line 119) — 기록 제4,842쪽(압수·수색·검증 영장), 제4,854쪽(수사 개시 통보), 제4,874쪽(피의자 신문조서), 제5,167쪽(불기소 이유 통지) 4개 문서 인용 — CONFIRMED
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.3.1 (line 119) — "취사 선별적 훈령 적용, 동일성의 오류, 시간 역전의 물리법칙 위배, 문장의 주어(주체)를 숨겨 은닉" — CONFIRMED
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.3.1 (line 119) — 에드먼드 버크 인용 — CONFIRMED
