...
**Source:** raw/01. book-beyond-cybersecurity/Korean/13-3-7-37-제7층위-진정서.md (book §3.7.1.1)
...
- `Korean/13-3-7-37-제7층위-진정서.md` — §3.7.1.1 line 10: explicit inline date `2022.9.25.` adjacent to 기록 제5,393쪽 citation. This is the only date reference in the chapter for this document.
