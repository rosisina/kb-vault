...
**Source:** raw/01. book-beyond-cybersecurity/Korean/11-3-5-35-제-5층위.md (book §3.5.2.4, excluding §3.5.2.4.1)
...
## 원전 확인 (Spot-check)
- `Korean/11-3-5-35-제-5층위.md` — §3.5.2.4 lines 251–274: 이지영 중개(§3.5.2.4.2 lines 260–263), 시간 조율(§3.5.2.4.3 lines 265–268), 공모 붕괴(§3.5.2.4.4 lines 270–273) 일치 확인.
