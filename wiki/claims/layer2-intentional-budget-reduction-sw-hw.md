...
**Source:** raw/01. book-beyond-cybersecurity/Korean/08-3-2-32-제2-층위.md (§3.2.1.3)
...
- `Korean/08-3-2-32-제2-층위.md` lines 71–74: §3.2.1.3 원문과 일치. "국가계약법에 따른 순수 소프트웨어 개발 용역 사업" 확인. 6.25억 확인. 기록 제4,866~4,871, 제1,056, 제1,074, 제1,535 모두 확인. 추가 요구사항 80건 확인.
- `Korean/08-3-2-32-제2-층위.md` lines 66–68: §3.2.1.2 문맥에서 사업통제기관으로서의 국유단의 비정상적 역할 구조 확인.
