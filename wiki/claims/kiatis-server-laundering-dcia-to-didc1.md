...
**Source:** raw/01. book-beyond-cybersecurity/Korean/08-3-2-32-제2-층위.md (§3.2.2)
...
- `Korean/08-3-2-32-제2-층위.md` lines 84–88 (장우진 conversation)
- `Korean/08-3-2-32-제2-층위.md` line 50, footnote 87 (Active-X + VPN 부재 + 2016 해킹 attack surface 가설)
- `Korean/08-3-2-32-제2-층위.md` line 82 (「전군 통합 메일」 사업의 KIATIS 호스트 사실)
- `Korean/07-3-1-31-제1층위-ActiveX.md` (Layer 1 chapter — server history detail)
