...
- `Korean/08-3-2-32-제2-층위.md` — Layer 2 chapter discusses 사업통제기관 / 사업주관기관 / 사업관리기관 role structure
- `Korean/10-3-4-34-제4-층위.md` — Layer 4 chapter
- `Korean/12-3-6-36-제6층위-군.md` — Layer 6 chapter (prosecutor handling of role tiers)
