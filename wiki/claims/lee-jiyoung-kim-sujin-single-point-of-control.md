...
**Source:** raw/01. book-beyond-cybersecurity/Korean/08-3-2-32-제2-층위.md (§3.2.1.2 footnote 85, §3.2.2 footnote 109, §3.2.3 main paragraph), ../defense-kg-platform/kg/pseudonym_mapping.json (id 2 + id 11)
...
- `Korean/08-3-2-32-제2-층위.md` line 50, footnote 85 — 비교 사업 PCA 담당
- `Korean/08-3-2-32-제2-층위.md` line 78, footnote 109 — work-simplification 공문 결재자
- `Korean/08-3-2-32-제2-층위.md` line 82, footnote 112 — 「전군 통합 메일」 승인
- `Korean/08-3-2-32-제2-층위.md` line 97 — §3.2.3 main thesis paragraph
