...
- `Korean/10-3-4-34-제4-층위.md` — Layer 4 (primary, contains 시험평가 구분 and 사업관리기관/사업주관기관 discussion)
- `English/14-3-4-34-Fourth-Layer.md` §3.4.4.2.3 — contains the Article 57 comparison discussion. **Note:** the book's Article 57 comparative table was shown by P6 blind re-measurement to omit the 제2398호 hedge insertion (see [[2398-2842ho-otne-environment-hedge-flipflop]] Book-side audit note); whether the table also undercaptures the DT&E-side symmetric deletion is an open question for the next A.6 Re-verify pass.
