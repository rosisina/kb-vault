...
SET fr.layer = 4,
    fr.claimType = "witness_dishonesty",
...
- `vault-converted-korean/10-3-4-34-제4-층위.md` lines 149-159

## Related

- [[didc-falsely-records-old-kiatis-as-vpn-user]] — L4 DIDC 허위 기재
- [[didc-excluded-from-test-eval-reform]] — L4 DIDC 배제
