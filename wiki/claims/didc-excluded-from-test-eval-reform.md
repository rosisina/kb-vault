...
DIDC was systematically excluded from the entire test evaluation reform process:

1. **KIDA research phase** (January–June 2020): DIDC not involved
2. **Task Force phase** (August 2020 – January 2021): DIDC not involved
3. **국전원 standardization phase** (February–December 2021): DIDC not involved
4. **All manipulation official documents in Figure 4-7**: DIDC not a recipient

As the server infrastructure operator, DIDC directly manages the application and operation of security equipment — VPN, firewall, and DB access control (ChakraMax). Configuring the security of the test evaluation environment is impossible without DIDC cooperation. By excluding this key party, the question of accountability for VPN non-application was structurally blocked from discussion.

## 핵심 요약 (Key Takeaways)
- DIDC는 시험평가 개혁 3단계 전체 및 조작된 모든 공문에서 체계적으로 배제 — VPN·방화벽·DB접근제어 담당 인프라 운영기관임에도 [진리성]
...
- 보안장비 적용 책임기관을 배제하면 VPN 미적용 책임 논의 자체가 차단됨 [타당성]
...
- 이 배제는 2016년 해킹 및 舊KIATIS 보안 결함에서 DIDC의 역할을 은폐하는 패턴과 일치 [진리성]
