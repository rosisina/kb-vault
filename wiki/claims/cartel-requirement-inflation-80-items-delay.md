...
**Source:** raw/01. book-beyond-cybersecurity/vault-converted-korean/12-3-6-36-제6층위-군.md (§3.6.5.1.1) • raw/01. book-beyond-cybersecurity/vault-converted-english/16-3-6-36-Sixth-Layer.md
...
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.5.1.1 — 기록 제3,039쪽, 정리06, 정리07 직접 인용 — CONFIRMED
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.5.1.1 — 기록 제11,322쪽~제11,345쪽 박서준 진술 — CONFIRMED
- `vault-converted-korean/12-3-6-36-제6층위-군.md` §3.6.5.1.2 — GIS 서버 예산 미반영 사실과 80건의 연동 — CONFIRMED
