...
**Source:** raw/01. book-beyond-cybersecurity/Korean/10-3-4-34-제4-층위.md (book §3.4.6.3)
...
## 원전 확인 (Spot-check)
- `Korean/10-3-4-34-제4-층위.md` — §3.4.6.3: 기록 제5,950~5,953쪽 및 기록 제3,068쪽 인용 확인. "사전에 두 조직 간에 합의된 시나리오의 실행" 기술 확인. Active-X 제거의 이중 성격 기술 확인.
