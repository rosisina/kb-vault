...
**Source:** raw/01. book-beyond-cybersecurity/Korean/10-3-4-34-제4-층위.md (§3.4.7.3.2)
...
- `Korean/10-3-4-34-제4-층위.md` §3.4.7.3.2 (line 591) — "시험평가의 정의는 2016.6.16.(제1931호)에서부터 2025.7.9.(제3059호)에 이르기까지 그 개정이 없이 동일하게" — CONFIRMED
- `Korean/10-3-4-34-제4-층위.md` §3.4.7.3.2 (line 591) — "기록 제9003쪽부터" 별표1 정의 시작 — CONFIRMED
- `Korean/10-3-4-34-제4-층위.md` §3.4.7.3.2 (line 591) — 조작된 정의 "정보시스템 전력화 여부를 판단하기 위해...(기록 제4759쪽)" — CONFIRMED
- `Korean/10-3-4-34-제4-층위.md` §3.4.7.3.2 (line 597) — "정리08: 국방부가 작성한...공문은 조작된 것이다" — CONFIRMED
