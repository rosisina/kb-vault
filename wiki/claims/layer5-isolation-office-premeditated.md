...
**Source:** raw/01. book-beyond-cybersecurity/vault-converted-korean/11-3-5-35-제-5층위.md (book §3.5.1.5 / §3.5.2.3.5)
...
- `vault-converted-korean/11-3-5-35-제-5층위.md` — §3.5.1.5, §3.5.2.3.5, §3.5.3.2.1: 모두 일치. 책은 사전 공모 구조를 별도 절로 다루며, 김민수 발언을 결론 사전 결정의 독립 증거로 분류한다.
