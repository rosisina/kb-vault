...
- `vault-converted-korean/07-3-1-31-제1층위-ActiveX.md` — Layer 1 chapter (CONFIRMED SSL-VPN match)
- `vault-converted-korean/10-3-4-34-제4-층위.md` — Layer 4 chapter (CONFIRMED SSL-VPN match)
- `vault-converted-korean/12-3-6-36-제6층위-군.md` — Layer 6 chapter (CONFIRMED SSL-VPN match)
