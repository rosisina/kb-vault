...
**Source:** raw/01. book-beyond-cybersecurity/Korean/09-3-3-33-제3-층위.md (§3.3.1.2)
...
- `Korean/09-3-3-33-제3-층위.md` §3.3.1.2 (lines 23–27) — 본 atom의 전체 진술 원문.
- `Korean/10-3-4-34-제4-층위.md` — §3.3.1.2 각주 내 "제4층위에서 증명" 언급의 구체적 검증 내용 cross-check 필요.
