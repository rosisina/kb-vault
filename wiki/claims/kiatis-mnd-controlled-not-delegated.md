...
- `vault-converted-korean/08-3-2-32-제2-층위.md` lines 11–13 (§3.2.1.1) — primary source, 5근거 모두 본 단락 안에 명시
- `vault-converted-korean/13-3-7-37-제7층위-진정서.md` — 법적 분류 인용 cross-check
- `vault-converted-korean/04-1-1-서론.md` — 국정과제 도입 부분
