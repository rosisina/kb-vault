...
**Source:** raw/01. book-beyond-cybersecurity/Korean/08-3-2-32-제2-층위.md §3.2 (line 73)
...
- `Korean/08-3-2-32-제2-층위.md` line 73 — 6.25억 예산 + 80건 추가 요구사항
- `Korean/09-3-3-33-제3-층위.md` §3.3.1.2 — 의도적 업무 이관
