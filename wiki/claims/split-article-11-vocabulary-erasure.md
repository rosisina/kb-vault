---
lang: ko
title-ko: 훈령 제2436호의 3대 용어 교체로 불법 위임을 지칭 불가능하게 만든 어휘 조작
title-en: ""
aliases:
  - FR-L4-VOCABULARY-ERASURE
  - 훈령 제2436호의 3대 용어 교체로 불법 위임을 지칭 불가능하게 만든 어휘 조작

layer: 4
secondary-layers: []
claimType: regulatory_manipulation
claimSubtype: vocabulary_erasure
fracture-type: F-MS
source-type: book
...
**Source:** raw/01. book-beyond-cybersecurity/Korean/10-3-4-34-제4-층위.md §3.4.4.4.2 (lines 383-402)
...
SET fr.layer = 4,
    ...
    fr.summary = "3대 용어 교체로 위반 사실의 지칭 자체를 불가능하게 만든 어휘적 증거 인멸.";
```
...
- When '사업통제기관' disappears, the violation becomes linguistically unnameable [타당성]
...
국방 행정 표준화 정책에 따른 용어 통일

## 반증 조건 (Falsification Condition)
다른 중앙행정기관에서 2018년 이전에 동일 용어가 사용된 사례

## 평결 (Verdict)
**CORROBORATED.** STRONG. 진리성 9 / 타당성 10 / 진실성 7.

## 원전 확인 (Spot-check)
- `Korean/10-3-4-34-제4-층위.md` lines 383-402
