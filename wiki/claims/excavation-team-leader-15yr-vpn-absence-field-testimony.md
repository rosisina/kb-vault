...
At the KIATIS normalization meeting on 2022-02-08 (Recording 220, approximately 4 hours), the excavation team leader (최인권), who had used KIATIS in the field for 15 years from 2007 — progressing from excavation soldier to forensic specialist to team leader — independently confirmed the non-use of VPN and ChakraMax (DB access control) through **7 verbatim statements**.

### Statement 1 (01:08:55): Reason for VPN — 'heard it' = never experienced it

> **(Excavation Team Leader)** "VPN을 우리가 사용하는 이유가 군사지도 사용하는 것으로 이야기를 들었습니다." ("I heard the reason we use VPN is for military maps.")

A field user with 15 years of KIATIS use described VPN's reason as something he 'heard' (secondhand) — proof by negation that he had never personally experienced using VPN.

### Statement 2 (01:08:55): 'Living outside for 10 months... because of VPN'

> **(Excavation Team Leader)** "저희는 10개월 동안 바깥에서 생활을 하는데. VPN 때문에. 이 발굴보고서가 완성되면은 단에 들어와서 다른 부대에서 할 수 없기 때문에" ("We live outside for 10 months. Because of VPN. When the excavation report is completed, we have to come into the unit because it can't be done from other units.")

If VPN had been applied, KIATIS would have been inaccessible in the field for 10 months — paradoxical proof that previously, direct DB access without VPN was used from anywhere.
