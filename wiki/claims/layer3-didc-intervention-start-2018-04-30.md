...
**Source:** raw/01. book-beyond-cybersecurity/Korean/09-3-3-33-제3-층위.md (§3.3.4 footnote 148)
...
SET fr.layer = 3,
    ...
    fr.claimSubtype = "temporal_attribution",
...
The starting point at which DIDC, the principal actor of Layer 1, **began actively intervening in manipulations** of the New KIATIS Enhancement Project and related directive revisions under Layer 3 Defense Information Agency jurisdiction was **2018-04-30**. The initial intervention evidence document is DIDC → Defense Information Agency Administrative Informatization Division's "2018 Information Resource Acquisition and Replacement Project Specification Review Result Notification." From this point onward, all modifications to informatization infrastructure-related articles in the MND's post-2018 directive revisions should be interpreted as relating to DIDC's New KIATIS project affairs.
...
- **Book §3.3.4 footnote 148 (Korean/09-3-3-33-제3-층위.md line 76):** "DIDC가 본 사안에 대해 본격적으로 조작에 개입한 시점은 2018.4.30.일부터이다. 그에 대한 증거는 DIDC에서 국전원 행정 정보화과로 보낸 「18년 정보자원 도입 및 교체사업 규격심의 결과 통보」공문에서부터 이다."
...
- `Korean/09-3-3-33-제3-층위.md` line 76 footnote 148 — 단언 문장.
- `Korean/07-3-1-31-제1층위-ActiveX.md` — Layer 1 시점 DIDC의 舊KIATIS 이력 제거 사업과의 연결.
- `Korean/08-3-2-32-제2-층위.md` — Layer 2 서버 laundering 타임라인과의 정합성.
...
- [[layer3-vpn-otp-card-used-2021-not-2019|VPN OTP 카드 2021년 최초사용]] (RELATED)
- [[kiatis-server-laundering-dcia-to-didc1|KIATIS 서버 laundering DCIA→DIDC1]] (RELATED)
- [[2436ho-cluster-six-anchors|2436호 6-anchor cluster]] (RELATED)
- [[2436ho-didc-naming-anchor-removed|2436호 DIDC anchor 삭제]] (RELATED)
- [[2263ho-cyber-routing-rewrite|2263호 사이버 routing 개정]] (RELATED)
