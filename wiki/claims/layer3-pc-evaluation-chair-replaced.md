...
**Source:** raw/01. book-beyond-cybersecurity/Korean/09-3-3-33-제3-층위.md (§3.3.3.3)
...
- `Korean/09-3-3-33-제3-층위.md` §3.3.3.3 (line 64) + footnote 141/142.
- `Korean/10-3-4-34-제4-층위.md` — Layer 4 평가위원회 80개 위반 구조와 cross-check.
