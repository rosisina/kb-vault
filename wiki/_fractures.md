...
- **F-SC (자기모순)** — true logical contradiction (A∧¬A) within a single document. The only type where '모순' is the precise term.
- **F-CE (반증)** — counter-evidence that falsifies the official hypothesis.
- **F-MS (조작 징후)** — temporal/pattern anomalies indicating deliberate manipulation.
- **F-SE (선별 적용)** — same standard applied differentially to different actors.
- **F-AA (부재 논증)** — mandatory artifact absent (modus tollens).

Open fractures are a visible project health metric — the goal is for every entry to eventually resolve into a [[claims/_index|claim]] with a Popper verdict.
...
**Layer:** 1 • **Subtype:** F-MS (조작 징후) • **Type:** directive entity-anchor removal • **Atom:** [[claims/2436ho-didc-naming-anchor-removed]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** modus-tollens (mandatory artifact absent) • **Atom:** [[claims/didc-sop-incident-report-mandatory]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** modus-tollens • **Atom:** [[claims/didc-sop-firewall-vpn-trail-mandatory]] • **Verdict:** CORROBORATED (strong) — *highest-priority ingress trace*
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** modus-tollens • **Atom:** [[claims/didc-sop-db-access-control-mandatory]] • **Verdict:** CORROBORATED (strong) — *highest-priority egress trace*
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** modus-tollens • **Atom:** [[claims/didc-sop-11-backup-recovery-mandatory]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 • **Subtype:** F-CE (반증) • **Type:** regulatory classification (5-ground convergence) • **Atom:** [[claims/kiatis-mnd-controlled-not-delegated]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 • **Subtype:** F-CE (반증) • **Type:** structural violation (multi-cap PCA) • **Atom:** [[claims/kiatis-mkia-multi-cap-inscription]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 (+L1/L4/L6 cross-bridge) • **Subtype:** F-MS (조작 징후) • **Type:** actor-continuity single-point-of-control • **Atom:** [[claims/lee-jiyoung-kim-sujin-single-point-of-control]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 (+L1 cross-bridge) • **Subtype:** F-MS (조작 징후) • **Type:** evidence-chain obfuscation • **Atom:** [[claims/kiatis-server-laundering-dcia-to-didc1]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 (+L6 reverse-bridge) • **Subtype:** F-CE (반증) • **Type:** exculpatory active defense • **Atom:** [[claims/han-ji-hoon-three-braking-devices-active-defense]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 (+L5/L6 cross-bridge) • **Subtype:** F-MS (조작 징후) • **Type:** personnel record manipulation • **Atom:** [[claims/han-ji-hoon-officer-personal-record-manipulation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 (+L1 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** coordinated regulatory rebuild • **Atom:** [[claims/2436ho-cluster-six-anchors]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** regulatory principle inversion • **Atom:** [[claims/2436ho-test-evaluation-principle-inverted]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** wholesale article deletion • **Atom:** [[claims/2436ho-dtne-articles-erased]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** role-binding erasure (DT&E-side) • **Atom:** [[claims/2436ho-dtne-sponsor-binding-erased]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 (+L6 secondary) • **Subtype:** F-SC (자기모순) • **Type:** test-evaluation procedural self-contradiction • **Atom:** [[claims/layer4-evaluation-committee-80-items-violation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 + 6 • **Subtype:** F-CE (반증) • **Type:** directive misapplication (legal) • **Atoms:** [[claims/kiatis-2129ho-main-regime-applies]] + [[claims/prosecution-misapplies-2129-article-58-4-to-kiatis]] • **Verdict:** both CORROBORATED (strong)
...
**Layer:** 4 + 6 • **Subtype:** F-CE (반증) • **Type:** temporal law applicability • **Atom:** [[claims/kiatis-rfp-binds-lifecycle]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 (+L7 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** temporal forensic proof • **Atom:** [[claims/layer5-48hr-retaliation-causal-link]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 (+L7 secondary) • **Subtype:** F-CE (반증) • **Type:** workplace-rights violation (documented) • **Atom:** [[claims/layer5-six-month-isolation-human-rights]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 (+L6 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** procedural inversion • **Atom:** [[claims/layer5-predetermined-audit-conclusion]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** fabricated official document • **Atom:** [[claims/layer5-fabricated-warning-letter]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** complaint-structure falsification • **Atom:** [[claims/layer5-park-seojun-nominal-complainant]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 (+L7 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** pre-planning / premeditation • **Atom:** [[claims/layer5-isolation-office-premeditated]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** structural role-separation violation • **Atom:** [[claims/han-ji-hoon-prosecution-violates-2129-role-separation]] • **Verdict:** CORROBORATED (strong) — **foundational Layer 6 contradiction**
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** outcome-framing contradiction • **Atom:** [[claims/han-ji-hoon-kiso-yuye-is-criminal-stigma]] • **Verdict:** CORROBORATED (strong) — **foundational framing contradiction**
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** directive textual misapplication • **Atom:** [[claims/prosecution-misapplies-2129-article-58-4-to-kiatis]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 (+L7 secondary) • **Subtype:** F-CE (반증) • **Type:** decisional-locus institutional awareness • **Atom:** [[claims/han-ji-hoon-dan-jang-phone-call-2022-09-28]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 (+L5 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** procedural inversion / retrospective case construction • **Atom:** [[claims/han-ji-hoon-witness-statement-2022-01-25]] • **Verdict:** CORROBORATED (moderate)
...
**Layer:** 6 • **Subtype:** F-AA (부재 논증) • **Type:** procedural protection failure • **Atom:** [[claims/han-ji-hoon-investigation-notification-2022-07-21]] • **Verdict:** CORROBORATED (moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** evidence substrate design / question-framing avoidance • **Atom:** [[claims/han-ji-hoon-suspect-interrogation-2022-09-02]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 (+L4 secondary) • **Subtype:** F-MS (조작 징후) • **Type:** deliberate delay mechanism / cover-up operational window • **Atom:** [[claims/cartel-requirement-inflation-80-items-delay]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 (+L6 secondary) • **Subtype:** F-AA (부재 논증) • **Type:** structural institutional-failure proof • **Atom:** [[claims/han-ji-hoon-rebuttal-rejected-by-eight-institutions]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-CE (반증) • **Type:** source-date adjudication • **Atom:** [[claims/han-ji-hoon-rebuttal-document-date-2022-09-25]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-MS (조작 징후) • **Type:** civilian-oversight-body capture • **Atom:** [[claims/kwonikkwi-evidence-transfer-attempt-to-mnd]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-AA (부재 논증) • **Type:** procedural duty violation • **Atom:** [[claims/inkkwonwi-rejected-without-witness-review]] • **Verdict:** CORROBORATED (strong)
...
## Candidate fractures — Checkpoint 2 denominator (draft 2026-04-11, post-promotion 2026-04-11)

**Purpose.** This section is the **draft denominator for Checkpoint 2** (project completion = every core fracture expressed as a claim-atom pair, `_fractures.md` auto-generated from atom metadata). Each entry below was extracted from an existing claim atom in `wiki/claims/` — the fracture is already latent in the atom's `Claim` + `Counter-hypothesis` structure; this section simply externalizes it for adjudication tracking.

**Format.** `- **C-L{N}-{NN}** — short description → [[claims/atom]] | verdict`

**How this denominator evolves.**
1. Each candidate below represents a known fracture axis. Promoting a candidate to **Open** (full entry, like C-L4-01) happens when (a) the adjudicating atom is `CORROBORATED (strong)` AND (b) a lint pass confirms no conflicting counter-evidence, OR (c) a new source surfaces that requires reopening the fracture for further adjudication.
...
4. The `_fractures.md` auto-generation script (`scripts/rebuild-hubs.py`, pending) will eventually regenerate this file from atom frontmatter — at that point this hand-drafted denominator becomes the seed schema.

**Scale observation.** 33 candidates extracted from 37 existing atoms in the first draft (≈ 1:0.9 atom:contradiction ratio). Post Track C + Branch 2 + miscellaneous atom expansion (2026-04-11), vault atom count is **47** and denominator grows accordingly. If Checkpoint 2 expands to the target ~300–500 atoms, expect **~225–375 fractures** at maturity. The 1:1 working assumption from the earlier completion-definition discussion is approximately validated.
...
Combined with the 38 pre-existing Open entries, total Open fractures: **196**.
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/active-x-removal-as-project-goal-confirms-vulnerability]] • **Verdict:** CORROBORATED (strong)
...
#### C-L1-12 — intranet-link-attack-surface

**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/intranet-link-attack-surface]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/csr-annual-vulnerability-assessment-duty-violated]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/csr-cyber-asset-registry-catch-all-art45]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/csr-didc-is-2nd-tier-security-ops-center]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/csr-kiatis-is-cyber-asset-under-directive]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/didc-sop-12-emergency-response-team-logs-mandatory]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/didc-sop-12-incident-scene-preservation-mandatory]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/didc-sops-cover-2016-hacking-period]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/kiatis-homepage-co-managed-by-admin-ops-team]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kiatis-homepage-improvement-disguised-as-maintenance]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/kiatis-rfp-tech-table-proves-sw-only-internet-structure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kiatis-server-laundering-to-integrated-mail-server]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer1-foundation-of-seven-layer-system]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/old-kiatis-apt-optimal-vulnerability-structure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/old-kiatis-direct-db-access-without-vpn]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/old-kiatis-hosted-inside-other-server-15-years]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/old-kiatis-intranet-data-link-confirmed]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/old-kiatis-web-facade-masking-cs-direct-db]] • **Verdict:** CORROBORATED (strong)

舊KIATIS는 구조적 기만을 내포한 이중구조 시스템이다:

#### C-L1-30 — prosecution-six-charges-collapse-vpn-nonexistence

**Layer:** 1 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/prosecution-six-charges-collapse-vpn-nonexistence]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 1 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/xsyn-sop-incident-silence-equals-coverup-proof]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/gukyu-dan-dual-cap-unprecedented-structure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 2 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/new-kiatis-is-mnd-controlled-not-delegated-project]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 3 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/han-ji-hoon-three-safeguard-mechanisms]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 3 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kiatis-project-deliberately-transferred-to-han-ji-hoon]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/2576ho-article-62-5-ote-approval-deleted]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/2576ho-article-64-failure-blindspot]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/80-items-violate-national-contract-law]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/article-58-separation-to-integration-2020-directive-manipulation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/audit-dtot-report-hidden-from-team-leader]] • **Verdict:** CORROBORATED (strong)
...
#### C-L4-15 — article-58-five-year-stability-then-reversal

**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/article-58-five-year-stability-then-reversal]] • **Verdict:** CORROBORATED (strong)
...
#### C-L4-16 — evaluation-post-completion-temporal-impossibility

**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/evaluation-post-completion-temporal-impossibility]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/cross-atom-99-7-plus-80items-plus-data-absence]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/didc-commander-hwang-prior-knowledge-lie]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/didc-excluded-from-test-eval-reform]] • **Verdict:** CORROBORATED (strong)

DIDC는 시험평가 개혁의 전 과정에서 체계적으로 배제되었다:

#### C-L4-20 — didc-falsely-records-old-kiatis-as-vpn-user

**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/didc-falsely-records-old-kiatis-as-vpn-user]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/didc-withheld-network-diagram-from-kiatis]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/directive-article-11-control-functions-stripped]] • **Verdict:** CORROBORATED (strong)

사업통제기관의 4대 핵심 기능이 훈령 개정을 통해 연속적으로 삭제되었다:

#### C-L4-23 — fabricated-document-2020-produced-in-2022

**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/fabricated-document-2020-produced-in-2022]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/firewall-requests-confirm-no-vpn-db-direct-access]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/gukjeonwon-pre-evaluation-team-leader-exclusion]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kida-recommends-gukjeonwon-centered-integration]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kida-research-legitimizes-pre-existing-manipulation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kim-min-su-central-cross-layer-cartel-figure]] • **Verdict:** CORROBORATED (strong)

김민수 (핵심 의사결정자-1)는 국방정보화카르텔의 교차층위 핵심 인물이다:

#### C-L4-29 — layer4-997-military-adequate-verdict-vs-sabotage

**Layer:** 4 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/layer4-997-military-adequate-verdict-vs-sabotage]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-activex-removal-request-during-evaluation-conspiracy]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer4-dtot-separation-principle-violated]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-evaluation-item-change-after-completion]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-evidence-becomes-layer6-prosecution-tool]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-kida-workflow-omits-mnd-role]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer4-old-new-kiatis-different-cyberspace]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-post-evaluation-illegal-control-transfer-to-gukyu-dan]] • **Verdict:** CORROBORATED (strong)
...
#### C-L4-37 — layer4-procedure-simplification-temporal-manipulation-2019-09

**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-procedure-simplification-temporal-manipulation-2019-09]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer4-software-install-to-system-install-terminology-fabrication]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer4-test-evaluation-separation-principle-directive-2129]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/mnd-fabricated-indo-stage-terminology-blame-shift]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/mnd-test-eval-simplification-timed-to-evaluation-day]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/mnd-test-evaluation-definition-manipulation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/mnd-test-evaluation-improvement-retroactive-justification]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-article-11-vocabulary-erasure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/split-kim-min-su-false-ignorance-vs-career]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-temporal-reversal-2019-09-02-forgery]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/supervision-report-concealment-selective-circulation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/terminology-manipulation-role-concept-distortion]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/xsyn-80items-additional-not-defects-triangulated]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/xsyn-directive-2436-retroactive-legal-basis]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/apt-human-targeting-3yr-11mo-personalized]] • **Verdict:** CORROBORATED (strong)
...
#### C-L5-08 — fabricated-warning-wrong-title

**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/fabricated-warning-wrong-title]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/harassment-complaint-48hrs-premeditated-isolation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/investigation-bureau-dark-audit-as-fraud-model]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/investigation-bureau-fake-harassment-7-phase-process]] • **Verdict:** CORROBORATED (strong)

조사본부의 허위 갑질 조사는 7단계 프로세스를 따랐다 (§3.5.2.3.2):

#### C-L5-12 — kim-min-su-apology-evidence-manufacturing

**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kim-min-su-apology-evidence-manufacturing]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-audit-result-falsity-and-collusion-proof]] • **Verdict:** CORROBORATED (strong)

조사본부의 조사 결과는 허위이며, 이는 **6가지 독립적 증명**에 의해 입증된다:

#### C-L5-14 — layer5-choi-dongwook-dual-role-lawyer-or-conspirator

**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-choi-dongwook-dual-role-lawyer-or-conspirator]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-choi-youngsu-testimony-exposes-joseo-fabrication]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-collective-witness-abandonment-selective-memory]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-evidence-destruction-frame-behavioral-paralysis]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-excavation-team-old-kiatis-internet-proof]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-false-gapjil-report-organizational-conspiracy-structure]] • **Verdict:** CORROBORATED (strong)

허위 갑질 신고는 **3단계 공모 구조**로 작동했다:

#### C-L5-20 — layer5-fraud-investigation-triangular-model

**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-fraud-investigation-triangular-model]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-historical-significance-apt-human-targeting]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-investigation-bureau-pre-collusion-triple-conspiracy]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-kakaotalk-silence-proves-normal-attendance]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-kim-min-su-conspiracy-admission-sufficiently-discussed]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-kim-min-su-discharge-ultimatum-escalation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-kyungbuk-network-conflict-of-interest]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-language-weaponization-silence-as-murder]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-lee-ji-young-false-dinner-testimony-three-witnesses]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-lee-taeho-testimony-work-dumping-exploitation]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-park-seojun-gaslighting-victim-or-accomplice]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-reporter-3stage-statement-change]] • **Verdict:** CORROBORATED (strong)

갑질 신고에서 박서준 (갑질신고자-1)의 진술이 3단계로 변화한다:

#### C-L5-32 — layer5-reversed-truth-nine-evidence-rebuttal

**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer5-reversed-truth-nine-evidence-rebuttal]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-six-month-witness-destruction-tactics]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-triangular-collusion-speech-act-timeline]] • **Verdict:** CORROBORATED (strong)

세 조직(국전원, 조사본부, 법무관리관실) 사이의 공모는 **발화 패턴을 통해 4단계 시간 조율**로 증명된다:

#### C-L5-35 — layer5-yang-mi-suk-silence-as-active-complicity

**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer5-yang-mi-suk-silence-as-active-complicity]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/lee-ji-young-double-play-park-seo-jun-incitement-han-ji-hoon-blocking]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/lee-jiyoung-covert-sabotage-confirmed-by-kim-minsu]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/lee-jiyoung-jikgwon-josa-flip-flop-hours]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-kim-min-su-organizational-support-cutoff]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-lee-jiyoung-5min-triple-reversal]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-post-collapse-escalation-to-prosecution]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/warning-letter-reflects-only-lee-jiyoung]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/choi-dongwook-resignation-threat-coercive-control]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/choi-dongwook-technical-ignorance-despite-months]] • **Verdict:** CORROBORATED (strong)
...
#### C-L6-12 — selective-criminalization-approval-chain

**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/selective-criminalization-approval-chain]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/cross-layer-witness-destroy-then-summon-pipeline]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/firewall-port-opening-standard-it-procedure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/four-kiatis-environments-non-identical]] • **Verdict:** CORROBORATED (strong)

정리04에 따르면 4개의 KIATIS 관련 환경은 모두 서로 비동일하다:

#### C-L6-16 — gukyu-dan-data-absence-delays-new-kiatis

**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/gukyu-dan-data-absence-delays-new-kiatis]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/interrogation-son-schizophrenia-prosecution-aware]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/interrogation-zero-of-14-projects-measured-vpn]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/investigator-admits-warrant-phantom-reference]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kim-min-su-post-prosecution-personal-problem-framing]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/kim-min-su-vpn-speed-no-impact-admission]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-997-reframed-as-deficient-development]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-cartel-network-structure-four-documents-four-keywords]] • **Verdict:** CORROBORATED (strong)

군 검찰단의 한지훈에 대한 사기수사는 **4대 문서**와 **4대 키워드**로 구조적으로 정의된다.

#### C-L6-24 — layer6-didc-center1-true-hacking-host

**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer6-didc-center1-true-hacking-host]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-gis-server-budget-intentional-omission]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer6-judicial-murder-permanent-family-destruction]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-phase1-success-result-neutralization-2019-2020]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-phase2-blame-shift-2020-2021]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/layer6-phase3-trap-activation-criminalization-2021-2022]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/layer6-prosecutor-violated-anti-corruption-five-principles]] • **Verdict:** CORROBORATED (strong)

군 검찰단의 新KIATIS 수사는 자체 준거 규범인 **"군 수사 절차상 인권 보호 등에 관한 훈령"(제2502호, 2020-12-30, 기록 제00118쪽/제00187쪽)의 반부패 수사 5대 원칙 전부를 정반대로 위반**했다:

#### C-L6-31 — lee-junho-false-testimony-self-contradiction

**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/lee-junho-false-testimony-self-contradiction]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/mnd-control-agency-role-evasion-deployment-delay]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/non-prosecution-admits-test-not-actual-but-blames-only-victim]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/non-prosecution-mitigating-factors-describe-normal-work]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-article-57-directive-laundering]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/prosecution-baeim-charge-self-contradictory]] • **Verdict:** CORROBORATED (strong)

군검찰단의 업무상배임 혐의는 내적 모순으로 인해 자기 붕괴한다:

#### C-L6-37 — prosecution-distorts-operational-vs-test-environment

**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-distorts-operational-vs-test-environment]] • **Verdict:** CORROBORATED (strong)

군 검찰단이 생산한 4개 핵심 수사 문서가 '실제 운영 대 시험평가' 환경의 동일성과 차이를 공통으로 왜곡하였다:

#### C-L6-38 — prosecution-false-document-charge-self-contradiction

**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/prosecution-false-document-charge-self-contradiction]] • **Verdict:** CORROBORATED (strong)

군검찰단의 불기소결정서(L6-031-1)에서 **허위공문서작성** 혐의에 대해, 군검찰은 이준호 (공모자-1)가 작성한 3건의 문서를 지목하였다:

#### C-L6-39 — prosecution-firewall-port-opening-vs-it-standard-practice

**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/prosecution-firewall-port-opening-vs-it-standard-practice]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/prosecution-fraud-meets-criminal-elements]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-identity-fallacy-deception-technique]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/prosecution-investigator-ignorance-environment]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/prosecution-knew-innocence-continued-case]] • **Verdict:** CORROBORATED (strong)

군검찰단 수사관은 한지훈의 무혐의를 인지하면서도 수사를 계속하였다(기록 제11,188쪽의 대화에서 확인).

#### C-L6-44 — prosecution-non-prosecution-identity-error-fraud

**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-non-prosecution-identity-error-fraud]] • **Verdict:** CORROBORATED (strong)
...
#### C-L6-45 — prosecution-non-prosecution-self-contradiction

**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/prosecution-non-prosecution-self-contradiction]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-omits-saup-tongje-gigwan-from-rfp-structure]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecution-principal-actor-in-cartel]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/prosecution-selective-criminalization-firewall-approval-chain]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/prosecutor-admits-no-corruption-still-charges]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/prosecutor-shifted-charge-vpn-to-firewall]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/split-cartel-three-phase-2016-2025]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/victim-blaming-structural-to-individual]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/warrant-docs-are-actual-false-documents]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/warrant-omits-15yr-vpn-bypass-from-probable-cause]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/warrant-vs-non-prosecution-document-truth-reversal]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/xsyn-prosecutor-post-warrant-arrival-predetermination]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/xsyn-recording-confirms-vpn-public-discussion]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 6 • **Subtype:** F-SE (선별 적용) • **Type:** see atom • **Atom:** [[claims/xsyn-sop-vpn-mandate-vs-prosecution-cherry-pick]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/cross-layer-predetermined-conclusion-L5-L6-L7]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/han-ji-hoon-petition-to-mnd-minister-2022]] • **Verdict:** CORROBORATED (strong)
...
#### C-L7-07 — kim-min-su-willful-ignorance-firewall-self-contradiction

**Layer:** 7 • **Subtype:** F-SC (자기모순) • **Type:** see atom • **Atom:** [[claims/kim-min-su-willful-ignorance-firewall-self-contradiction]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-MS (조작 징후) • **Type:** see atom • **Atom:** [[claims/kiso-yuye-six-charges-dishonorable-discharge]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/kwonikkwi-petition-submission-and-result]] • **Verdict:** CORROBORATED (strong)

한지훈은 2022년 9월 25일 국가권익위원회에 진정서를 제출했다(기록 제5,314쪽~제5,326쪽). 진정서는 다음을 포함한다:

#### C-L7-10 — seven-layer-organic-crime-system-proven

**Layer:** 7 • **Subtype:** F-CE (반증) • **Type:** see atom • **Atom:** [[claims/seven-layer-organic-crime-system-proven]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 7 • **Subtype:** F-AA (부재 논증) • **Type:** see atom • **Atom:** [[claims/whistleblower-protection-purely-formal]] • **Verdict:** CORROBORATED (strong)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/2436ho-dtne-sponsor-binding-erased]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 4 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/2436ho-otne-sponsor-binding-erased]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/choi-dongwook-parrots-prosecution-delay-narrative]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/choi-dongwook-show-weakness-vs-innocence-defense]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-AA (부재 논증) • **Atom:** [[claims/han-ji-hoon-investigation-notification-2022-07-21]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/han-ji-hoon-witness-statement-2022-01-25]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Atom:** [[claims/kakaotalk-han-ji-hoon-professional-engagement-during-eval]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-CE (반증) • **Atom:** [[claims/kakaotalk-lee-jiyoung-normal-management-pre-complaint]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 2 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/layer2-intentional-budget-reduction-sw-hw]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/layer5-lee-jiyoung-vpn-5questions-motive-confirmation]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/layer5-park-seojun-48hr-cooperation-to-hostility]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/layer5-warning-letter-overrides-investigation-findings]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/new-kiatis-delay-three-strategic-objectives]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 3 • **Subtype:** F-CE (반증) • **Atom:** [[claims/park-sung-ho-officer-disparagement-publicized]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/split-delay-cyclical-budget-embezzlement]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 6 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/split-delay-team-leader-elimination-framing]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
**Layer:** 5 • **Subtype:** F-MS (조작 징후) • **Atom:** [[claims/total-destruction-unperson-triple-vector]] • **Verdict:** CORROBORATED (strong — upgraded from moderate)
...
- **intranet-link-attack-surface** — 舊KIATIS는 인터넷 기반이면서 동시에 인트라넷(국방망)과 데이터를 송수신하는 이중 연동 구조였다(기록 제1,117쪽, 제1,125쪽). 단순 인터넷 홈페이지가 아니라 2016 DIDC 해킹 시 인터넷→국방망 공격 경로를 제공한 bridge 시스템이었으며, 이를 은폐할 동기가 커버업의 핵심이다. → [[claims/intranet-link-attack-surface]] | CORROBORATED (strong)
...
- **article-58-five-year-stability-then-reversal** — 제58조의 시험평가 분리 원칙이 제1775호(2015.1.27)부터 제2398호(2020.2.13)까지 5년간 안정적으로 유지되었다가 제2436호(2020.6.4)에서 4개월 만에 통합 원칙으로 180도 전환(기록 제7,512쪽, 제8,194쪽). 5년 안정 후 돌연 역전은 자연적 정책 진화가 아닌 의도적 조작의 시... → [[claims/article-58-five-year-stability-then-reversal]] | CORROBORATED (strong)
- **evaluation-post-completion-temporal-impossibility** — 평가 항목 변경 요청(2019.9.5) → 시험평가 종료(2019.9.11) → 평가 항목 변경 승인(2019.9.19, 국유단장). 승인이 평가 종료 8일 후에 이루어진 것은 시간적 불가능이며, 국유단이 사업통제기관 역할을 불법 자임한 증거. 2020-08 MND 공문(기록 제4,757쪽)이 이를 '제도 개선'으로... → [[claims/evaluation-post-completion-temporal-impossibility]] | CORROBORATED (strong)
...
- **layer4-997-military-adequate-verdict-vs-sabotage** — 新KIATIS 시험평가위원회(비상설)는 **99.7%의 고득점과 함께 "군사용 적합" 판정**을 하였다 (Record No. 3,041). 이 판정은 한지훈의 적극적 사업관리 하에 달성되었으며, 국유단 성능개선 TF(Record No. 1,073) 실무자들이 평가위원으로 참석하여 내린 결정이다. 한지훈은 요구사항 검... → [[claims/layer4-997-military-adequate-verdict-vs-sabotage]] | CORROBORATED (strong)
...
- **layer4-procedure-simplification-temporal-manipulation-2019-09** — 2019년 9월 2일, 국방부 소프트웨어융합정책담당관 이지영(공문결재자-1)과 김수진(행정담당자-1)이 "정보시스템 구축 시험평가 절차 간소화 추진 계획 검토 요청"(기록 제2,853쪽~제2,858쪽)을 발송했다. 이 문서에는 두 가지 시간적 모순이 존재한다: → [[claims/layer4-procedure-simplification-temporal-manipulation-2019-09]] | CORROBORATED (strong)
...
- **fabricated-warning-wrong-title** — 법무관리관실 경고장(2022.5.23)은 한지훈의 직위를 '행정정보계획팀장'으로 기재하였으나, 이 직위는 자원정보화과에도 행정정보화과에도 존재하지 않는다. 한지훈의 2022.2.28 기준 공식 직위는 '자원정보화과 국방정보화사업담당'(기록 제1,586쪽). 동일한 오류가 피의자신문조서(기록 제4,878쪽)에도 나타나... → [[claims/fabricated-warning-wrong-title]] | CORROBORATED (strong)
...
- **selective-criminalization-approval-chain** — 방화벽 정책적용 공문의 결재선(기안자 이준호, 검토자 한지훈, 결재자 최영수) 중 중간 검토자만 피의자 지정. 최종 결재자(30년 IT 전문가, 서기관)는 참고인, 기안자는 배제. 최영수는 5시간 참고인 조사에서 방화벽 포트 개방의 기술적 정당성을 진술하였으나 검찰은 이를 반박하지 못함. 결재선 내 선택적 범죄자 만... → [[claims/selective-criminalization-approval-chain]] | CORROBORATED (strong)
...
- **lee-junho-false-testimony-self-contradiction** — 이준호 (공모자-1)의 참고인 진술(기록 제1,171쪽): "실제 기반운영환경에서는 DB에 바로 접근하는 방식으로 운용할 수 없다." → [[claims/lee-junho-false-testimony-self-contradiction]] | CORROBORATED (strong)
...
- **prosecution-non-prosecution-self-contradiction** — 군 검찰단의 불기소 이유서는 사기수사의 전형적 모델을 보여주는 문서이다. 핵심 모순: 위계공무집행방해로 "피의사실은 인정된다"며 기소유예 처분을 내리면서, 동시에 "KIATIS는 개발·운용시험평가에서 99.73점을 받은 바 있어 제안요구서에서 요구한 기능들을 대부분 충족하는 것으로 보이고"(10페이지)라고 사업의 성... → [[claims/prosecution-non-prosecution-self-contradiction]] | CORROBORATED (strong)
...
- **kim-min-su-willful-ignorance-firewall-self-contradiction** — 2022-03-23, 김민수는 '조사에 대해서 일체 모른다', '일절 관여를 못해'라고 선언. 그러나 1개월 전 녹취006에서 '감사조치 등등은 내가 알아서 할 거고'로 감사실과 직접 조율. 1개월 만에 '적극 개입자'→'일절 모르는 자'로 전환은 관여 흔적 차단을 위한 방화벽 구축. → [[claims/kim-min-su-willful-ignorance-firewall-self-contradiction]] | CORROBORATED (strong)
